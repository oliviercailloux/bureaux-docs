...
* Remzy (actuellement en P647) et Jérôme Lang acceptent de partager le bureau de Jérôme (P645), à la condition expresse que d’autres personnes jouent le jeu. Précision de Jérôme : Pour avoir la garantie que les visiteurs et émérites soient convenablement logés, avoir un seul bureau nous semble insuffisant : il suffit que, par exemple, Remzi et Jérôme L. aient chacun un visiteur en même temps pour que ce bureau soit entièrement occupé, ne laissant donc pas de place à d'autres visiteurs ou aux émérites. Obtenir un second bureau est possible s'il y a d'autres permanents (que ceux déjà listés) qui coopèrent. Une autre façon d'expliquer  "que d'autres personnes jouent le jeu" est d'envisager un roulement chaque année, et que chaque permanent (sauf responsabilités très importantes) s'engage à coopérer pendant au moins un an au cours des 3 années à venir.
